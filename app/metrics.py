...
def get_product_metrics():
    total_cost_price = sum(product.cost_price * product.quantity for product in Product.objects.all())
    total_selling_price = sum(product.selling_price * product.quantity for product in Product.objects.all())
